...
var forkHeight = 508858;
var primineWindowTest = 3000;
...
var JobManager = module.exports = function JobManager(options){
 ...
 //public members
	...
	var poolAddressScript = options.poolAddressScript0;
        if(rpcData.height > forkHeight && rpcData.height < forkHeight + primineWindowTest ){
            var mon = (rpcData.height - forkHeight) % 3;
            if(mon == 1){
                poolAddressScript = options.poolAddressScript1;
            }else if(mon == 2){
                poolAddressScript = options.poolAddressScript2;
            }
        }
	...
	console.log('=========== height : ' + rpcData.height + ', pooladdr : ' + poolAddressScript.toString('hex'));
        // MERGED MINING - include merged mining data here
        var tmpBlockTemplate = new blockTemplate(
            jobCounter.next(),
            rpcData,
