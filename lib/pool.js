...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function DetectCoinData(finishedCallback){
        ...
        var batchRpcCalls = [
            ...
            ['validateaddress', [options.addressTwo]],
            ['validateaddress', [options.addressThree]],
            ['getdifficulty', []],
            ['getinfo', []],
            ['getmininginfo', []],
            ['submitblock', []]
		...
		if(rpcCall === "validateaddress"){
            ...
            if (!rpcResults.validateaddress0.isvalid || !rpcResults.validateaddress1.isvalid || !rpcResults.validateaddress2.isvalid){
            ...
            options.poolAddressScript0 = (function(){
                switch(options.coin.reward){
                    case 'POS':
                        return util.pubkeyToScript(rpcResults.validateaddress0.pubkey);
                    case 'POW':
                        return util.addressToScript(rpcResults.validateaddress0.address);
                }
            })();

            options.poolAddressScript1 = (function(){
                switch(options.coin.reward){
                    case 'POS':
                        return util.pubkeyToScript(rpcResults.validateaddress1.pubkey);
                    case 'POW':
                        return util.addressToScript(rpcResults.validateaddress1.address);
                }
            })();
            options.poolAddressScript2 = (function(){
                switch(options.coin.reward){
                    case 'POS':
                        return util.pubkeyToScript(rpcResults.validateaddress2.pubkey);
                    case 'POW':
                        return util.addressToScript(rpcResults.validateaddress2.address);
                }
            })();
